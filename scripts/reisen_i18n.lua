...
local ZH = {
	s = {
		...
		SCRAPBOOK_CHARM = "噩梦燃料补充25%，恐怖燃料补充双倍。施加50%理智惩罚，但屏蔽一切其他负面理智效果。卸下时损失部分耐久。受击时有一定概率召唤恐怖尖喙并消耗燃料。被多个暗影生物包围或者饥饿耗尽时，屏蔽效果失效。内置3格储物，自动消耗补充耐久。可放置暗影心房或者附身暗影心房以消除不同程度的负面效果。心房在位时，佩戴者周身散发柔和紫光，半径随理智档位增大（理智为0时最大约2.5）。附身暗影心房在位时，每自动消耗两份燃料额外向背包补给一枚邪恶花瓣。",
	...
	t = {
		...
		SCRAPBOOK_CHARM = "噩夢燃料補充25%，恐怖燃料補充雙倍。施加50%理智懲罰，但屏蔽一切其他負面理智效果。卸下時損失部分耐久。受擊時有一定機率召喚恐怖尖喙並消耗燃料。被多個暗影生物包圍或者飢餓耗盡時，屏蔽效果失效。內建3格儲物，自動消耗補充耐久。可放置暗影心房或者附身暗影心房以消除不同程度的負面效果。心房在位時，佩戴者周身散發柔和紫光，半徑隨理智檔位增大（理智為0時最大約2.5）。附身暗影心房在位時，每自動消耗兩份燃料額外向背包補給一枚邪惡花瓣。",
