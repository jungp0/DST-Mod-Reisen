...
local ZH = {
	s = {
		...
		SCRAPBOOK_CHARM = "噩梦燃料补充25%，恐怖燃料补充双倍。施加50%理智惩罚，但屏蔽一切其他负面理智效果。卸下时损失部分耐久。受击时有一定概率召唤恐怖尖喙并消耗燃料。被多个暗影生物包围或者饥饿耗尽时，屏蔽效果失效。内置3格储物，自动消耗补充耐久。可放置暗影心房或者附身暗影心房以消除不同程度的负面效果，并获得夜视。有附身暗影心房会定期给予深色花瓣。",
		...
		PETALS_EVIL_DRIED_RECIPE = "有股淡淡的香气，却又让人不安。",
		CHAR_TITLE = "月兔",
		CHAR_NAME = "月兔",
	...
	t = {
		...
		SCRAPBOOK_CHARM = "噩夢燃料補充25%，恐怖燃料補充雙倍。施加50%理智懲罰，但屏蔽一切其他負面理智效果。卸下時損失部分耐久。受擊時有一定機率召喚恐怖尖喙並消耗燃料。被多個暗影生物包圍或者飢餓耗盡時，屏蔽效果失效。內建3格儲物，自動消耗補充耐久。可放置暗影心房或者附身暗影心房以消除不同程度的負面效果，並獲得夜視。有附身暗影心房會定期給予深色花瓣。",
		...
		PETALS_EVIL_DRIED_RECIPE = "有股淡淡的香氣，卻又讓人不安。",
		CHAR_TITLE = "月兔",
		CHAR_NAME = "月兔",
...
local function ApplyToStrings(str, z)
	...
	str.RECIPE_DESC.PETALS_EVIL_DRIED = z.PETALS_EVIL_DRIED_RECIPE
