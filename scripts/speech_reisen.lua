return {
	...
	ANNOUNCE_REISEN_DUALGEAR = "I have a bad feeling about tonight.",
	ANNOUNCE_REISEN_DUALGEAR_FULLMOON = "Full moon... this setup will draw trouble.",
	ANNOUNCE_REISEN_VULNERABLE = "My sanity's drifting. Hits are going to hurt more.",
	ANNOUNCE_REISEN_HUNGER_MID_VULNERABLE = "Getting hungry... weak points are opening up.",
	ANNOUNCE_REISEN_HUNGER_VULNERABLE = "Stomach's empty. One good hit and I'm done.",
	ANNOUNCE_REISEN_STARVING = "I'm starving. My mind is slipping into the dark.",
	ANNOUNCE_REISEN_VULN_CHAIN = "If I get hit now, hunger will crash harder.",
	ANNOUNCE_REISEN_CHARM_SHADOW = "The ribbon called another shadow.",
	ANNOUNCE_REISEN_CHARM_INSANE = "They're coming.",
	ANNOUNCE_REISEN_MOLT_PROGRESS = "Molting cycle is progressing.",
	ANNOUNCE_REISEN_MOLT_READY = "A fresh tail came off.",
	ANNOUNCE_REISEN_MOLT_THERMO = "Thermal stress shook a tail loose.",
	ANNOUNCE_REISEN_STAGE_1 = "Lunacy peak.",
	ANNOUNCE_REISEN_ZERO_SAN_WORK = "I don't want to work right now!",
	ANNOUNCE_REISEN_MIND_BLOWING = "Mind Blowing!",
	ANNOUNCE_REISEN_MIND_STOPPER = "Mind Stopper.",
	ANNOUNCE_REISEN_MOON_PORT = "Moon Port!",
	...
	DESCRIBE =
	{
		...
		REISEN_CASUAL = "Off duty at last. Even my ears need a break.",
		REISEN_UNIFORM = "Lunar uniform on. Don't underestimate a rabbit.",
		REISEN_CHARM = "Are you still sane?",
	},
